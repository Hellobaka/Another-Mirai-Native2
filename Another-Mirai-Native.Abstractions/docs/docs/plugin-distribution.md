...
可以参考 [DependencyManifest-dotnet10.json](https://github.com/Hellobaka/Another-Mirai-Native2/blob/master/Another-Mirai-Native.Abstractions/tools/DependencyManifest-dotnet10.json)。

...
namespace Another_Mirai_Native.Abstractions.Context
{
    ...
    /// 提供用于描述群文件上传事件参数的类
    /// </summary>
    public class GroupFileUploadedContext(IPluginApi api, DateTime sendTime, Group fromGroup, QQ fromQQ, GroupFileInfo fileInfo)
    {
        /// <summary>
        /// 获取插件 API 实例
        /// </summary>
        ...
        /// 获取当前事件的文件信息
        /// </summary>
        public GroupFileInfo FileInfo { get; } = fileInfo;
    }
}

...
namespace Another_Mirai_Native.Abstractions.Handlers
{
    ...
    /// 为处理收到群文件上传事件的处理器。
    /// </summary>
    public class GroupFileUploadHandler
    {
        /// <summary>
        /// 在收到群文件上传时异步执行操作。
        /// </summary>
        /// <param name="e">包含收到群文件上传事件相关信息的事件参数对象。</param>
        ...
        public virtual Task<EventHandleResult> OnGroupFileUploaded(GroupFileUploadedEventArg e, CancellationToken ct) => Task.FromResult(EventHandleResult.Pass);
    }
}

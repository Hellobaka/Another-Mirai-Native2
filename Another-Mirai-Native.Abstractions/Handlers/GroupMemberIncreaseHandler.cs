...
namespace Another_Mirai_Native.Abstractions.Handlers
{
    ...
    /// 为处理群成员加入群聊事件的处理器。
    /// </summary>
    public class GroupMemberIncreaseHandler
    {
        /// <summary>
        /// 在群成员加入群聊时异步执行操作。
        /// </summary>
        /// <param name="e">包含群成员加入群聊事件相关信息的事件参数对象。</param>
        ...
        public virtual Task<EventHandleResult> OnGroupMemberIncrease(GroupMemberIncreaseEventArg e, CancellationToken ct) => Task.FromResult(EventHandleResult.Pass);
    }
}

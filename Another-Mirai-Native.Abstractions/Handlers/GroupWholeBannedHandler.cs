...
namespace Another_Mirai_Native.Abstractions.Handlers
{
    ...
    /// 为处理群全员禁言事件的处理器。
    /// </summary>
    public class GroupWholeBannedHandler
    {
        /// <summary>
        /// 在群全员禁言时异步执行操作。
        /// </summary>
        /// <param name="e">包含群全员禁言事件相关信息的事件参数对象。</param>
        ...
        public virtual Task<EventHandleResult> OnGroupWholeBanned(GroupWholeBannedEventArg e, CancellationToken ct) => Task.FromResult(EventHandleResult.Pass);
    }
}

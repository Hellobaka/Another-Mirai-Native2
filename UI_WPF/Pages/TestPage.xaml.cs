...
namespace Another_Mirai_Native.UI.Pages
{
    ...
    public partial class TestPage : Page
    {
        ...
        public CQPluginProxy? CurrentPlugin { get; private set; }
        ...
        private bool SendGroupMessage(string msg)
        {
            try
            {
                ...
                return PluginManagerProxy.Instance
                    .Event_OnGroupMsg(CurrentPlugin, 1, 1, groupId, qqId, "", msg, 0)
                    == 1;
            }
            catch (Exception ex)
            {
        ...
        private bool SendPrivateMessage(string msg)
        {
            try
            {
                ...
                return PluginManagerProxy.Instance
                    .Event_OnPrivateMsg(CurrentPlugin, 1, 1, qqId, msg, 0)
                    == 1;
            }
            catch (Exception ex)
            {

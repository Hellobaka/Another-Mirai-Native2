...
namespace Another_Mirai_Native.RPC.Interface
{
    public interface IClient
    {
        ...
        public object? InvokeCQPFunction(string function, bool waiting, params object[] args);
        ...
        /// <param name="args">参数</param>
        /// <returns>结果返回</returns>
        public Task<object?> InvokeCQPFunctionAsync(string function, bool waiting, params object[] args);
